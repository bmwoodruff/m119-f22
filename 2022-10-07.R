...
(f1(2.9)-f1(3))/(2.9-3)
(f1(2.99)-f1(3))/(2.99-3)
(f1(2.999)-f1(3))/(2.999-3)
(f1(3.001)-f1(3))/(3.001-3)
(f1(3.01)-f1(3))/(3.01-3)
(f1(3.1)-f1(3))/(3.1-3)
(f1(3.5)-f1(3))/(3.5-3)
(f1(4)-f1(3))/(4-3)

x <- c(2, 2.5, 2.9, 2.99, 2.999, 3.001, 3.01, 3.1, 3.5, 4)
(f1(x)-f1(3))/(x-3)


f2 <- function(x){exp(2*x)-1}
f2(0)
x <- c(1,0.5, 0.01, 0.001,0,-0.001,-0.01,-0.05,-1)
data.frame(
  x = x, 
  y = f2(x), 
  slope = (f2(x)-f2(0))/(x-0)
...
f3(2)
x <- c(1,1.5, 1.99, 1.99999999999,2, 2.0000000001, 2.01, 2.5, 3)
data.frame(
  x = x, 
  y = f3(x), 
  slope = (f3(x)-f3(2))/(x-2)
